...
export const seedLivestock: Livestock[] = [
  ...
  { id: "rf003", name: "Friesian Bull", slug: "friesian-bull", category: "Bulls", breed: "Friesian", gender: "Male", age: "2 Years", weight: "620 kg", price: 200000, currency: "KES", shortDescription: "A mature dairy bull with good body condition.", description: "A mature dairy bull maintained with attention to nutrition, health and body condition.", healthStatus: "Healthy", vaccination: "Up to date", availability: "Available", featured: true, published: true, images: img("/gallery/cattle-herd.jpg", "Friesian Bull"), createdAt: ts(), updatedAt: ts() },
  ...
  { id: "rf009", name: "Boer Doe", slug: "boer-doe", category: "Goats", breed: "Boer", gender: "Female", age: "18 Months", weight: "48 kg", price: 25000, currency: "KES", shortDescription: "Breeding Boer doe in good condition.", description: "Breeding Boer doe selected for meat production and flock growth.", healthStatus: "Healthy", vaccination: "Up to date", availability: "Available", featured: true, published: true, images: img("/gallery/boer-goat-standing.jpg", "Boer Doe"), createdAt: ts(), updatedAt: ts() },
  { id: "rf010", name: "Boer Buck", slug: "boer-buck", category: "Goats", breed: "Boer", gender: "Male", age: "2 Years", weight: "78 kg", price: 35000, currency: "KES", shortDescription: "Strong Boer buck for breeding.", description: "Strong Boer buck maintained for breeding and meat production.", healthStatus: "Healthy", vaccination: "Up to date", availability: "Available", featured: false, published: true, images: img("/gallery/boer-goat-side.jpg", "Boer Buck"), createdAt: ts(), updatedAt: ts() },
  { id: "rf011", name: "Young Boer Goat", slug: "young-boer-goat", category: "Goats", breed: "Boer", gender: "Male", age: "8 Months", weight: "32 kg", price: 18000, currency: "KES", shortDescription: "Young Boer goat growing well.", description: "Young Boer goat under careful feeding and management.", healthStatus: "Healthy", vaccination: "Up to date", availability: "Available", featured: false, published: true, images: img("/gallery/boer-goat-young.jpg", "Young Boer Goat"), createdAt: ts(), updatedAt: ts() },
  { id: "rf012", name: "Dairy Bull Calf", slug: "dairy-bull-calf", category: "Bulls", breed: "Friesian", gender: "Male", age: "10 Months", weight: "280 kg", price: 85000, currency: "KES", shortDescription: "Growing dairy bull calf with strong frame.", description: "Growing Friesian bull calf selected for dairy genetics and body development.", healthStatus: "Healthy", vaccination: "Up to date", availability: "Available", featured: true, published: true, images: img("/gallery/friesian-calf.jpg", "Dairy Bull Calf"), createdAt: ts(), updatedAt: ts() },
];
...
export const seedBlog: BlogPost[] = [
  { id: "b1", title: "Better calf nutrition starts early", slug: "better-calf-nutrition-starts-early", excerpt: "Healthy calves need consistent feeding, clean water and close observation.", content: "Healthy calves need consistent feeding, clean water and close observation. Early nutrition sets the foundation for lifelong productivity.", category: "Nutrition", author: "Rafiki Farm", featuredImage: "/gallery/friesian-calf.jpg", published: true, publishedAt: ts(), createdAt: ts(), updatedAt: ts() },
  { id: "b2", title: "Reading your animal's body condition", slug: "reading-body-condition", excerpt: "Body condition can tell a farmer a lot before a problem becomes obvious.", content: "Body condition can tell a farmer a lot before a problem becomes obvious. Regular scoring helps catch issues early.", category: "Livestock", author: "Rafiki Farm", featuredImage: "/gallery/cattle-herd.jpg", published: true, publishedAt: ts(), createdAt: ts(), updatedAt: ts() },
...
export const seedGallery: GalleryItem[] = [
  ...
  { id: "g3", title: "Cattle herd", category: "Cattle", image: "/gallery/cattle-herd.jpg", featured: true, createdAt: ts() },
  { id: "g4", title: "Friesian calf", category: "Calves", image: "/gallery/friesian-calf.jpg", featured: true, createdAt: ts() },
  { id: "g5", title: "Dorper rams", category: "Sheep", image: "/gallery/dorper-rams.jpg", featured: false, createdAt: ts() },
  { id: "g6", title: "Boer goats", category: "Goats", image: "/gallery/boer-goats-group.jpg", featured: true, createdAt: ts() },
  { id: "g7", title: "Dorper ewe", category: "Sheep", image: "/gallery/dorper-ewe.jpg", featured: false, createdAt: ts() },
  { id: "g8", title: "Boer goat", category: "Goats", image: "/gallery/boer-goat-profile.jpg", featured: false, createdAt: ts() },
];
