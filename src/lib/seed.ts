...
export const seedTraining: TrainingItem[] = [
  ...
  { id: "t2", title: "Animal Nutrition", slug: "animal-nutrition", description: "How feeding, water and body condition work together.", content: "Understanding the fundamentals of livestock nutrition.", category: "Animal Nutrition", image: "https://images.unsplash.com/photo-1594761051656-8f0a7b3e3c31?auto=format&fit=crop&w=800&q=80", published: true, createdAt: ts(), updatedAt: ts() },
